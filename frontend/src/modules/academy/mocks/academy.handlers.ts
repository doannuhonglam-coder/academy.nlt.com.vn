...
const mockCourses: CourseBrief[] = [
  ...
  },
  {
    ...
    description: 'Xây dựng sản phẩm web thật từ A-Z. Học bằng cách làm — không slide, không lý thuyết.',
    content_type: 'internal',
    proficiency_level: 'L2',
    thumbnail_url: null,
    lesson_count: 20,
  ...
  },
  {
    ...
    description: 'Khoá kiểm định toàn diện — hoàn thành để nhận Nhile Certificate được các doanh nghiệp công nhận.',
    content_type: 'internal',
